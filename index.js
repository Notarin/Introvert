...
client.on('message', msg => {
  ...
  if (command == "join") {
    msg.member.voice.channel.join().then(connection =>{connection.play(ytdl("https://www.youtube.com/watch?v=dQw4w9WgXcQ"), { filter : 'audioonly' });}).catch(err => console.log(err));
